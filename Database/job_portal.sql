...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 19, 2024 at 08:01 AM
...
DROP TABLE IF EXISTS `tbl_academic_qualification`;
...
DROP TABLE IF EXISTS `tbl_other_attachments`;
...
DROP TABLE IF EXISTS `tbl_professional_qualification`;
...
DROP TABLE IF EXISTS `tbl_referees`;
