...
$query1 = "SELECT * FROM tbl_jobs WHERE category = :cate AND country = :country WHERE title='$myprofession' ORDER BY enc_id DESC LIMIT $page1,12";
$query2 = "SELECT * FROM tbl_jobs WHERE category = :cate AND country = :country WHERE title='$myprofession' ORDER BY enc_id DESC";
$fromsearch = true;
...
$query1 = "SELECT * FROM tbl_jobs WHERE title='$myprofession' ORDER BY enc_id DESC LIMIT $page1,12";
$query2 = "SELECT * FROM tbl_jobs WHERE title='$myprofession' ORDER BY enc_id DESC";	
$slc_country = "NULL";
$slc_category = "NULL";	
$title = "Job List: Matched on Your Profession";
}
?>
...
<head>
	...
	<title>JobAbility - <?php echo "$title"; ?></title>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> BSIT4-B</p>
