...
<head>
	...
	<title>JobAbility - Register</title>
...
if (isset($_POST['Register'])) {
    ...
    $companyType = mysqli_real_escape_string($connection, $_POST['CompanyType']);
    ...
    $insert_query = "INSERT INTO tbl_registration (CompanyName, CompanyType, EmailAddress, Password, PasswordConfirmation) 
                     VALUES ('$companyName', '$companyType', '$emailAddress', '$password', '$passwordConfirmation')";
    ...
    if (mysqli_query($connection, $insert_query)) {
        ...
        $error_message = mysqli_real_escape_string($connection, mysqli_error($connection));
        echo "<script>
            Swal.fire({
                position: 'top-end',
                icon: 'error',
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>JobAbility is an online job portal developed by ....</p>
