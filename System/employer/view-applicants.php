...
<head>
	...
	<title>JobAbility - Applicants for the job <?php echo "$job_title"; ?></title>
				...
				<a target="_blank" href="../employee-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix">
					...
					<div class="content">
						...
						<form action="update_status.php" method="POST">
							...
							<button type="submit" class="btn" style="background-color: darkcyan; color: white">Update</button>
						</form>
					</div>
			</div>
		</div>
