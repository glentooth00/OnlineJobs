...
<head>
	...
	<title>JobAbility - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> NISU <br/> Lemery Campus <br/>School Junction</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:JobAbility@gmail.com">JobAbility@gmail.com</a>
								</li>
								<li>
